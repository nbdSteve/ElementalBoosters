...
public abstract class AbstractGui {
     ...
     */
    public AbstractGui(ConfigurationSection section, String type, Integer size, Player player) {
        ...
        if (!type.equalsIgnoreCase("none")) {
            ...
            this.inventory = Bukkit.createInventory(null, size, ColorUtil.colorize(section.getString("name").replace("{player}", player.getName())));
        }
